...
def get_binary_name() -> str:
    """Get the stepflow-server binary name for the current platform."""
    if platform.system() == "Windows":
        return "stepflow-server.exe"
    return "stepflow-server"


def get_binary_path() -> Path:
    """Get the path to the bundled stepflow-server binary.

    Returns:
        Path to the stepflow-server binary
    ...
    raise FileNotFoundError(
        f"stepflow-server binary not found at {binary_path}. "
