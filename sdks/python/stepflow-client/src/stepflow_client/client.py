...
import yaml
from stepflow_api import ApiClient, Configuration
from stepflow_api.api import ComponentApi, FlowApi, HealthApi, RunApi
...
class StepflowClient:
    ...
    def __init__(self, base_url: str, timeout: float = 30.0):
        ...
        self._run_api = RunApi(self._api_client)
    ...
    async def health_check(self) -> HealthResponse:
        ...
        """
        return self._health_api.health_check()

    def health_check_sync(self) -> HealthResponse:
        """Check server health (sync version).
    ...
    async def store_flow(self, flow: str | Path | dict) -> StoreFlowResponse:
        ...
        return self._flow_api.store_flow(request)
    ...
    async def get_flow(self, flow_id: str) -> FlowResponse:
        ...
        """
        return self._flow_api.get_flow(flow_id)
    ...
    async def delete_flow(self, flow_id: str) -> None:
        ...
        Args:
            flow_id: The flow hash
        """
        self._flow_api.delete_flow(flow_id)
    ...
    async def create_run(
        ...
        *,
        ...
        return self._run_api.create_run(request)
    ...
    async def cancel_run(self, run_id: str) -> RunDetails:
        ...
        """
        return self._run_api.cancel_run(run_id)
    ...
    async def delete_run(self, run_id: str) -> None:
        ...
        Args:
            run_id: The run ID
        """
        self._run_api.delete_run(run_id)
    ...
    async def get_run_items(self, run_id: str) -> ListItemsResponse:
        ...
        """
        return self._run_api.get_run_items(run_id)
    ...
    async def get_run_steps(self, run_id: str) -> ListStepRunsResponse:
        ...
        """
        return self._run_api.get_run_steps(run_id)
    ...
    async def get_run_flow(self, run_id: str) -> RunFlowResponse:
        ...
        """
        return self._run_api.get_run_flow(run_id)
    ...
    async def list_components_detailed(
        ...
        """
        return self._component_api.list_components(include_schemas=include_schemas)
