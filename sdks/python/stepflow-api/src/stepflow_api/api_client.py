...
import stepflow_api.models
from stepflow_api import rest
from stepflow_api.api_response import ApiResponse
from stepflow_api.api_response import T as ApiResponseT
from stepflow_api.configuration import Configuration
from stepflow_api.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stepflow_api.models, klass)
