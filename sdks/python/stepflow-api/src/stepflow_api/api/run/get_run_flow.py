...
from ...models.run_flow_response import RunFlowResponse
...
) -> Any | RunFlowResponse | None:
    if response.status_code == 200:
        response_200 = RunFlowResponse.from_dict(response.json())
