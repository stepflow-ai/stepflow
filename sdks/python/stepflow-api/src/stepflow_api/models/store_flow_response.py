...
class StoreFlowResponse(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["flowId", "diagnostics"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of StoreFlowResponse from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of StoreFlowResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "diagnostics": Diagnostics.from_dict(obj["diagnostics"])
