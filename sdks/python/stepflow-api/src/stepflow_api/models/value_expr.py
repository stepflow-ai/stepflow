...
class ValueExpr(BaseModel):
    ...
    actual_instance: Coalesce | dict[str, ValueExpr] | InputRef | list[ValueExpr] | LiteralExpr | ModelIf | PrimitiveValue | StepRef | VariableRef | None = None
    ...
    def to_dict(
        self,
    ) -> dict[str, Any] | Coalesce | dict[str, ValueExpr] | InputRef | list[ValueExpr] | LiteralExpr | ModelIf | PrimitiveValue | StepRef | VariableRef | None:
