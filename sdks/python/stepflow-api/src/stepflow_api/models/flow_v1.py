...
class FlowV1:
    ...
    Attributes:
        ...
        examples (list[ExampleInput] | None | Unset): Example inputs for the workflow that can be used for testing and
            UI dropdowns.
        metadata (FlowV1Metadata | Unset): Extensible metadata for the flow that can be used by tools and frameworks.
    """
    ...
    metadata: FlowV1Metadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata: FlowV1Metadata | Unset
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FlowV1Metadata.from_dict(_metadata)
        ...
        flow_v1.additional_properties = d
        return flow_v1
