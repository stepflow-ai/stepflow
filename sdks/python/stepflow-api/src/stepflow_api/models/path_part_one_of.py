...
class PathPartOneOf(BaseModel):
    """
    PathPartOneOf
    """  # noqa: E501

    string: StrictStr = Field(alias="String")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of PathPartOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of PathPartOneOf from a dict"""
        if obj is None:
            return None
