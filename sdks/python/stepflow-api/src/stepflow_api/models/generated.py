...
#   timestamp: 2025-12-21T20:07:18+00:00
...
class BaseRef2(BaseModel):
    step: Annotated[Step, Field(description="# StepReference\nReference the output of a step.")]
...
class CreateBatchResponse(BaseModel):
    ...
    totalInputs: Annotated[int, Field(description="Total number of inputs in the batch", ge=0)]
...
class FlowInput(BaseModel):
    field: Annotated[str | None, Field(description="Optional field path within workflow input")] = None
...
class StepOutput(BaseModel):
    field: Annotated[str | None, Field(description="Optional field path within step output")] = None
    optional: Annotated[
        bool,
        Field(description="If true, the step_id may be skipped and this step still executed."),
    ]
    stepId: Annotated[str, Field(description="Which step produces this data")]


class Dependency2(BaseModel):
    stepOutput: Annotated[StepOutput, Field(description="Comes from another step's output")]


class Dependency(RootModel[Dependency1 | Dependency2]):
    root: Annotated[Dependency1 | Dependency2, Field(description="Source of input data")]
...
class Skipped(BaseModel):
    reason: Annotated[str | None, Field(description="Optional reason for why the step was skipped.")] = None


class FlowResult2(BaseModel):
    Skipped_1: Annotated[Skipped, Field(alias="Skipped", description="# Skipped\nThe step was skipped.")]
...
class HealthResponse(BaseModel):
    ...
    timestamp: Annotated[str, Field(description="Timestamp when health was checked (RFC3339 format)")]
...
class ListBatchesQuery(BaseModel):
    ...
    limit: Annotated[int | None, Field(description="Maximum number of results to return", ge=0)] = None
    offset: Annotated[int | None, Field(description="Number of results to skip", ge=0)] = None
...
class StepOverride(BaseModel):
    ...
    value: Annotated[
        Any,
        Field(description="The override value to apply, interpreted based on the override type."),
    ]
...
class TestServerHealthCheck(BaseModel):
    path: Annotated[str, Field(description='Path for health check endpoint (e.g., "/health").')]
...
class ValueRef(RootModel[Any]):
    root: Annotated[
        Any,
        Field(description="Any JSON value (object, array, string, number, boolean, or null)"),
    ]
...
class BaseRef(RootModel[BaseRef1 | BaseRef2 | BaseRef3]):
    root: Annotated[
        ...
        Field(description="An expression that can be either a literal value or a template expression."),
    ]
...
class ComponentInfo(BaseModel):
    ...
    description: Annotated[str | None, Field(description="Optional description of the component.")] = None
...
class CreateRunRequest(BaseModel):
    debug: Annotated[
        bool | None,
        Field(description="Whether to run in debug mode (pauses execution for step-by-step control)"),
    ] = None
    flowId: Annotated[BlobId, Field(description="The flow hash to execute")]
    ...
    variables: Annotated[
        ...
        Field(description="Optional variables to provide for variable references in the workflow"),
    ] = None


class Diagnostic(BaseModel):
    ignore: Annotated[bool, Field(description="Whether this diagnostic should be ignored by default")]
    level: Annotated[DiagnosticLevel, Field(description="The severity level")]
    message: Annotated[DiagnosticMessage, Field(description="The diagnostic message and type")]
    path: Annotated[list[str], Field(description="JSON path to the field with the issue")]
...
class ExampleInput(BaseModel):
    ...
    name: Annotated[str, Field(description="Name of the example input for display purposes.")]
...
class FlowResult1(BaseModel):
    Success: Annotated[ValueRef, Field(description="# Success\nThe step execution was successful.")]


class FlowResult3(BaseModel):
    Failed: Annotated[FlowError, Field(description="# Failed\nThe step failed with the given error.")]
...
class ListBatchRunsResponse(BaseModel):
    runs: Annotated[list[BatchRunInfo], Field(description="List of runs with batch context")]
...
class ListComponentsResponse(BaseModel):
    components: Annotated[list[ComponentInfo], Field(description="List of available components")]
...
class StepAnalysis(BaseModel):
    inputDepends: Annotated[ValueDependencies, Field(description="Input dependencies for this step")]
    skipIfDepend: Dependency | None = None


class StepRunResponse(BaseModel):
    component: Annotated[str | None, Field(description="Component name/URL that this step executes")] = None
    result: FlowResult | None = None
...
class TestCase(BaseModel):
    ...
    input: Annotated[ValueRef, Field(description="Input data for the workflow in this test case.")]
...
class TestServerConfig(BaseModel):
    args: Annotated[list[str] | None, Field(description="Arguments for the server command.")] = None
    ...
    workingDirectory: Annotated[str | None, Field(description="Working directory for the server process.")] = None
...
class DebugStepResponse(BaseModel):
    results: Annotated[dict[str, FlowResult], Field(description="Results of executed steps")]


class Expr1(BaseModel):
    field_from: Annotated[BaseRef, Field(alias="$from", description="The source of the reference.")]
...
class StepModel(BaseModel):
    component: Annotated[Component, Field(description="The component to execute in this step")]
    ...
    metadata: Annotated[
        dict[str, Any] | None,
        Field(description="Extensible metadata for the step that can be used by tools and frameworks."),
    ] = None
...
class TestConfig(BaseModel):
    cases: Annotated[list[TestCase] | None, Field(description="Test cases for the workflow.")] = None
    config: Annotated[
        Any | None,
        Field(
...
class FlowV1(BaseModel):
    description: Annotated[str | None, Field(description="The description of the flow.")] = None
    examples: Annotated[
        list[ExampleInput] | None,
        Field(description="Example inputs for the workflow that can be used for testing and UI dropdowns."),
    ] = None
    inputSchema: SchemaRef | None = None
    metadata: Annotated[
        dict[str, Any] | None,
        Field(description="Extensible metadata for the flow that can be used by tools and frameworks."),
    ] = None
    name: Annotated[str | None, Field(description="The name of the flow.")] = None
    output: Annotated[
        ValueTemplate | None,
        Field(description="The outputs of the flow, mapping output names to their values."),
    ] = None
    outputSchema: SchemaRef | None = None
    steps: Annotated[list[StepModel] | None, Field(description="The steps to execute for the flow.")] = None
...
class Flow1(FlowV1):
    schema_: Annotated[Literal["https://stepflow.org/schemas/v1/flow.json"], Field(alias="schema")]
...
class FlowAnalysis(BaseModel):
    ...
    outputDepends: Annotated[ValueDependencies, Field(description="Dependencies for the workflow output.")]
    steps: Annotated[
...
class FlowResponse(BaseModel):
    allExamples: Annotated[
        list[ExampleInput] | None,
        Field(description="All available examples (includes both examples and test cases)"),
    ] = None
    analysis: Annotated[FlowAnalysis, Field(description="Optional analysis of the flow")]
...
class AnalysisResult(BaseModel):
    ...
    diagnostics: Annotated[Diagnostics, Field(description="All diagnostics found during analysis")]
