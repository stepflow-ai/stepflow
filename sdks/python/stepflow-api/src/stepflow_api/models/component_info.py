...
class ComponentInfo:
    ...
    Attributes:
        ...
        input_schema (None | Schema | Unset):
        output_schema (None | Schema | Unset):
    """

    component: str
    description: None | str | Unset = UNSET
    input_schema: None | Schema | Unset = UNSET
    output_schema: None | Schema | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_schema, Unset):
            input_schema = UNSET
        elif isinstance(self.input_schema, Schema):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_input_schema(data: object) -> None | Schema | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_schema_type_1 = Schema.from_dict(data)
        ...
        def _parse_output_schema(data: object) -> None | Schema | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_schema_type_1 = Schema.from_dict(data)
