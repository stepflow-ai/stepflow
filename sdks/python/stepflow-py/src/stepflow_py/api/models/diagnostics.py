...
class Diagnostics(BaseModel):
    ...
    diagnostics: list[Diagnostic] = Field(description="All diagnostics found")
    num_fatal: Annotated[int, Field(strict=True, ge=0)] = Field(alias="numFatal")
    num_error: Annotated[int, Field(strict=True, ge=0)] = Field(alias="numError")
    num_warning: Annotated[int, Field(strict=True, ge=0)] = Field(alias="numWarning")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "diagnostics": [
                    Diagnostic.from_dict(_item) for _item in obj["diagnostics"]
                ]
                if obj.get("diagnostics") is not None
                else None,
                "numFatal": obj.get("numFatal"),
                "numError": obj.get("numError"),
                "numWarning": obj.get("numWarning"),
            }
        )
        return _obj
