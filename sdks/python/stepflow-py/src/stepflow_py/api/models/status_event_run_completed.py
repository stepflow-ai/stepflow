...
class StatusEventRunCompleted(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of StatusEventRunCompleted from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of StatusEventRunCompleted from a dict"""
        if obj is None:
            return None
