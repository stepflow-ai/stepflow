...
class InputRef(BaseModel):
    ...
    input: StrictStr = Field(description="JSONPath expression", alias="$input")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of InputRef from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of InputRef from a dict"""
        if obj is None:
            return None
