...
class DiagnosticMessageOneOf4(BaseModel):
    """
    ...
    error: StrictStr
    type: StrictStr
    __properties: ClassVar[list[str]] = ["stepId", "field", "error", "type"]

    @field_validator("type")
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["invalidReferenceExpression"]):
            raise ValueError(
                "must be one of enum values ('invalidReferenceExpression')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of DiagnosticMessageOneOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of DiagnosticMessageOneOf4 from a dict"""
        if obj is None:
            return None
