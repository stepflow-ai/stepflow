...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "http://localhost:7840/api/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("stepflow_py.api")
        ...
        return [
            {
                ...
                "description": "Default development server (port 7840)",
            }
        ]
