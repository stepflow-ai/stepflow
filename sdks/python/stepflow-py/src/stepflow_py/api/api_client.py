...
import stepflow_py.api.models
from stepflow_py.api import rest
from stepflow_py.api.api_response import ApiResponse
from stepflow_py.api.api_response import T as ApiResponseT
from stepflow_py.api.configuration import Configuration
from stepflow_py.api.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stepflow_py.api.models, klass)
