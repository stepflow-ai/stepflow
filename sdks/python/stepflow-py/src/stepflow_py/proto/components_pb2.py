...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COMPONENTINFOENTRY']._serialized_end=680
  _globals['_COMPONENTSSERVICE']._serialized_start=683
  _globals['_COMPONENTSSERVICE']._serialized_end=895
