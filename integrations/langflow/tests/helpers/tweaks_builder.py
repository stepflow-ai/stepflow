...
class TweaksBuilder:
    ...
    def add_env_tweak(self, component_id: str, field_name: str, env_var: str) -> "TweaksBuilder":
        ...
        Note:
            If the environment variable is not set, it will be tracked in missing_env_vars
        """
    ...
    def add_openai_tweaks(self, component_id: str, api_key_env: str = "OPENAI_API_KEY", **kwargs: Any) -> "TweaksBuilder":
        ...
        Args:
            ...
            **kwargs: Additional direct tweaks (e.g., temperature=0.8, model_name="gpt-4")
