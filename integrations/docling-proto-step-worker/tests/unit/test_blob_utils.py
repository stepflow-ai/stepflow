...
from docling_proto_step_worker.exceptions import BlobStoreError
...
class TestGetDocumentBytes:
    @pytest.mark.asyncio
    @patch("docling_proto_step_worker.blob_utils.blob_store")
    ...
    @pytest.mark.asyncio
    @patch("docling_proto_step_worker.blob_utils.httpx.AsyncClient")
