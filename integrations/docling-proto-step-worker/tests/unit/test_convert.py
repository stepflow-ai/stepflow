...
from docling_proto_step_worker.convert import (
    _parse_page_range,
    _run_conversion,
    convert_document,
)
...
class TestConvertDocument:
    ...
    @pytest.mark.asyncio
    @patch("docling_proto_step_worker.convert.put_document_blob")
    @patch("docling_proto_step_worker.convert.get_document_bytes")
