...
from docling_proto_step_worker.converter_cache import (
    ConverterCache,
    _options_hash,
    build_converter,
...
class TestConverterCache:
    ...
    @patch("docling_proto_step_worker.converter_cache.build_converter")
    ...
    @patch("docling_proto_step_worker.converter_cache._build_converter_from_config")
