...
mod tests {
    ...
    async fn test_error_isolation_between_items() {
        ...
        let behaviors = vec![
            (
                json!({"x": 1}),
                FlowResult::Failed(stepflow_core::FlowError::new(stepflow_core::TaskErrorCode::ComponentFailed, "Item 1 failed")),
            ),
            (
                json!({"x": 2}),
    ...
    async fn test_error_isolation_with_breadth_first() {
        ...
        let behaviors = vec![
            ...
            (
                json!({"x": 2}),
                FlowResult::Failed(stepflow_core::FlowError::new(stepflow_core::TaskErrorCode::ComponentFailed, "Middle item failed")),
            ),
            (
                json!({"x": 3}),
                FlowResult::Success(ValueRef::new(json!({"result": "ok"}))),
    ...
    async fn test_all_items_fail() {
        ...
        let behaviors = vec![
            (
                json!({"x": 1}),
                FlowResult::Failed(stepflow_core::FlowError::new(stepflow_core::TaskErrorCode::ComponentFailed, "Error 1")),
            ),
            (
                json!({"x": 2}),
                FlowResult::Failed(stepflow_core::FlowError::new(stepflow_core::TaskErrorCode::ComponentFailed, "Error 2")),
            ),
            (
                json!({"x": 3}),
                FlowResult::Failed(stepflow_core::FlowError::new(stepflow_core::TaskErrorCode::ComponentFailed, "Error 3")),
            ),
        ];
