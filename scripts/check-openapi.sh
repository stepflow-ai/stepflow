...
# CI check script for OpenAPI schema - validates schemas/openapi.yaml with Redocly CLI
#
...
run_check "Lint" npx @redocly/cli lint schemas/openapi.yaml --config .redocly.yaml || true
