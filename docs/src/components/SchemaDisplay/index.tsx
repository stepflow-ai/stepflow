...
const references = {
    "https://stepflow.org/schemas/v1/protocol.json": require("@site/static/schemas/v1/protocol.json"),
    "https://stepflow.org/schemas/v1/flow.json": require("@site/static/schemas/v1/flow.json"),
