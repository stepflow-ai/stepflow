...
"""End-to-end parity test for the stepflow-docling facade.

Exercises the deployed facade using the Docling paper from arXiv to verify
that the API is compatible with docling-serve.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="End-to-end parity test for the stepflow-docling facade."
    )
    parser.add_argument(
        "--base-url",
    ...
    print(f"Stepflow-Docling Parity Test — {base}")
