...
# Stepflow-Docling gRPC Parity Testbed — Teardown Script
...
echo "=== Stepflow-Docling gRPC Parity Testbed Teardown ==="
echo ""
echo "This will delete ALL stepflow-docling-grpc resources."
...
# 1. Workers
echo "[1/4] Removing workers..."
kubectl delete -f worker/ --ignore-not-found

# 2. Orchestrator
echo "[2/4] Removing orchestrator..."
